      ...
      public void actionPerformed(ActionEvent ae){
           ...
           try{
                ...
                if(t6.getText().equals("")){
                    ...
                    Conn c1 = new Conn();
                    String q1 = "insert into signups values('"+formno+"','"+name+"','"+fname+"','"+dob+"','"+gender+"','"+email+"','"+marital+"','"+address+"','"+city+"','"+pincode+"','"+state+"')";
               ...
               e.printStackTrace();
               JOptionPane.showMessageDialog(null, "Data contain some error");
            }
